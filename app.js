            ...
            <div className="nav-right">
                ...
                <a
                    ...
                    style={{
                        ...
                        backgroundColor: "rgb(160, 175, 82)",
                    }}
            ...
            <div className="contact">
                <div className="info">
                    ...
                    <div className="row">
                        ...
                        <div className="v">050-000-0000</div>
                    </div>
                    <div className="row">
                        <div className="k">EMAIL</div>
                        <div className="v">moshe@calistenix.com</div>
                    </div>
                    <div className="row">
                        <div className="k">INSTAGRAM</div>
                        <div className="v">@moshe.calisthenics</div>
                    </div>
                    <div className="row">
                    ...
                    {sent ? (
                        ...
                        >
                            ...
                            <div className="row">
                                ...
                                <div className="field">
                                    <label>טלפון</label>
                                    <input type="tel" placeholder="050-000-0000" />
                                </div>
                            </div>
                            <div className="row">
                                <div className="field">
