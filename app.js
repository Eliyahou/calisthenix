  ...
  return (
    <section id="pricing">
      ...
      <div className="pay-cta rule-b">
        <div className="lead">
          מוכנים להתחיל?
          <small>תשלום מאובטח בביט · ישירות לחשבון של משה</small>
        </div>
        <button className="btn btn--accent" onClick={() => setPayOpen(true)}>
          שלם בביט · {window.PAYMENT.amountLabel} <span className="arrow">→</span>
        </button>
      </div>
